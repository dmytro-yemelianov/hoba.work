...
const en = {
  ...
  'archetypes.pilotNote': 'A pilot: {n} of the atlas’s entries are placed so far, starting with the named patterns. More move in as they’re written.',
...
const uk: Record<UIKey, string> = {
  ...
  'archetypes.pilotNote': 'Пілот: {n} записів атласу вже розміщено, почавши з названих патернів. Далі додаватимуться ще.',
