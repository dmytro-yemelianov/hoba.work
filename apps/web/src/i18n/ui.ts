...
const en = {
  ...
  'nav.desc.archetypes': 'Nicknames and an alignment-chart grid — flavor, not a finding',
  'nav.actors': 'Actors',
  'lens.label': 'Read as',
  ...
  'entity.plural.actor': 'Actors',
  'entity.plural.record': 'Financial Records',
  'entity.plural.era': 'Eras',
  'entity.plural.process': 'Processes',
  ...
  'analyze.scenarios.remote_country_payroll_mismatch': 'Remote Payroll Mismatch',
  'analyze.scenarios.hybrid_cadence_disclosed_late': 'Late Hybrid Cadence',
  'analyze.scenarios.client_site_vendor_constraint': 'Client-Site Vendor Constraint',
  'analyze.scenarios.remote_timezone_overlap_limit': 'Remote Timezone Limit',
  'analyze.scenarios.ua_reservation_worksite_constraint': 'UA Reservation Worksite Constraint',
  'analyze.scenarios.referral_ranked_finalist': 'Referral Ranked Finalist',
  'analyze.scenarios.outbound_no_cohort_screen': 'Outbound, No Cohort',
  'analyze.scenarios.agency_bench_pool_submission': 'Agency Bench Pool',
  'analyze.scenarios.internal_transfer_precommitted_internal': 'Internal Candidate Precommit',
  'analyze.scenarios.dated_re_entry_lottery': 'Dated Re-entry Lottery',
  ...
  'archetypes.trueNeutral': 'True Neutral',
...
const uk: Record<UIKey, string> = {
  ...
  'entity.plural.actor': 'Актори',
  'entity.plural.record': 'Фінансові записи',
  ...
  'analyze.scenarios.remote_country_payroll_mismatch': 'Віддалена роль без payroll-покриття',
  'analyze.scenarios.hybrid_cadence_disclosed_late': 'Пізно розкрита гібридна каденція',
  'analyze.scenarios.client_site_vendor_constraint': 'Клієнтський майданчик у вендорському процесі',
  'analyze.scenarios.remote_timezone_overlap_limit': 'Віддалена роль з обмеженням таймзони',
  'analyze.scenarios.ua_reservation_worksite_constraint': 'Українське бронювання і місце роботи',
  'analyze.scenarios.referral_ranked_finalist': 'Referral і фінальна когорта',
  'analyze.scenarios.outbound_no_cohort_screen': 'Вихідний контакт без когорти',
  'analyze.scenarios.agency_bench_pool_submission': 'Агентська подача проти bench',
  'analyze.scenarios.internal_transfer_precommitted_internal': 'Внутрішній кандидат уже обраний',
  'analyze.scenarios.dated_re_entry_lottery': 'Повторний вхід і лотерея',
  ...
  'archetypes.trueNeutral': 'Істинно нейтральне',
