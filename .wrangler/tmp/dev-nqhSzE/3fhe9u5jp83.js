...
// .wrangler/tmp/pages-BdT54T/bundledWorker-0.3148811288520911.mjs
...
__name2(preferredLocale, "preferredLocale");
var MARKDOWN = /\.md$/;
...
__name2(isStaticAsset, "isStaticAsset");
...
__name2(legacyRedirect, "legacyRedirect");
...
__name2(internalPath, "internalPath");
var worker_default = {
  async fetch(request, env) {
    ...
    const internal = /* @__PURE__ */ __name2((path) => new Request(new URL(internalPath(path, lang, { markdown }), url.origin), request), "internal");
...
// node_modules/.pnpm/wrangler@4.112.0/node_modules/wrangler/templates/pages-dev-util.ts
...
// .wrangler/tmp/pages-BdT54T/3fhe9u5jp83.js
var define_ROUTES_default = {
  version: 1,
  description: "Only HTML navigations need language negotiation; everything below is served from disk unchanged. Patterns must not swallow a page: /data/* would also match the /data page, so the export directory is named exactly. Markdown is a representation of a page, not an asset, so .md stays with the Function.",
  include: [
    "/*"
  ],
  exclude: [
...
// .wrangler/tmp/bundle-b84i9q/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-b84i9q/middleware-loader.entry.ts
...
//# sourceMappingURL=3fhe9u5jp83.js.map
