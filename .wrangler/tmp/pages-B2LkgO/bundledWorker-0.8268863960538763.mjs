...
var worker_default = {
  async fetch(request, env) {
    ...
    const internal = /* @__PURE__ */ __name((path) => new Request(new URL(internalPath(path, lang, { markdown }), url.origin), request), "internal");
...
// ../../.wrangler/tmp/bundle-aQvFTA/middleware-insertion-facade.js
...
// ../../.wrangler/tmp/bundle-aQvFTA/middleware-loader.entry.ts
...
//# sourceMappingURL=bundledWorker-0.8268863960538763.mjs.map
