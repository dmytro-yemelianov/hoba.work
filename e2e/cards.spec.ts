...
test.describe('share cards', () => {
  ...
  test('the declared card is actually served, in both languages', async ({ request }) => {
    for (const url of ['/cards/en/obs.rejection_within_minutes_of_application_submission.png', '/cards/uk/obs.rejection_within_minutes_of_application_submission.png', '/cards/uk/mech.employment_gap_downranking_bias.png', '/cards/en/I-002.png']) {
