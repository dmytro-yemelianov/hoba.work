...
perspectives:
  -
    ...
    reads: "The penalty is a weight in an arithmetic that produces one number. A rank below the advance threshold reads the same whether it came from the match or from the deduction."
  ...
  -
    ...
    does: "Describes the interval and the work done inside it in the history itself. The date range is a fact of record, and it is what the ranking reads."
status: "active"
