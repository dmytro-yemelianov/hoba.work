...
perspectives:
  ...
  -
    ...
    does: "Keeps rendering and syndicating the posting and accepting applications, and closes the unreviewed ones when the expiry default reaches its threshold."
  -
    actor: "recruiter"
