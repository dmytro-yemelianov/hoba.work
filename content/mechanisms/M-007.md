...
perspectives:
  ...
  -
    actor: "recruiter"
    sees: "The requisition changes state in the system on a date, with the instruction that arrives with it. The forecast behind it is not something the recruiter is shown."
