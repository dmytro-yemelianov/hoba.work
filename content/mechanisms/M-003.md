...
perspectives:
  -
    ...
    does: "Resubmits in a single-column form with a text layer where the same file can be reapplied. This is the branch the candidate can act on without anyone's cooperation."
  -
    actor: "recruiter"
