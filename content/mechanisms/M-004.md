...
perspectives:
  ...
  -
    ...
    does: "Chooses when the number is said, which is the point where this can still be closed early. Saying it early ends a pipeline on a metric that is measured, and saves rounds on one that is not."
  -
    actor: "candidate"
