  ...
  -
    ...
    outcomes:
      ...
      -
        ...
        excludes:
          - "M-001"
        because: "A rejection arriving on a round calendar interval (e.g. 30/60 days) demonstrates an automated ATS queue expiry rule (M-011) rather than an active reviewer decision."
      -
        id: "posting-still-live"
        label: "The posting was still accepting applications when the rejection arrived."
        excludes:
          - "M-001"
        because: "A rejection arriving while the role remains active and seeking candidates indicates an automated knockout filter or ghost listing (M-006/M-008)."
      -
