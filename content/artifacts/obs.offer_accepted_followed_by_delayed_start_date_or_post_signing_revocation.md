---
id: "obs.offer_accepted_followed_by_delayed_start_date_or_post_signing_revocation"
type: "artifact"
aliases:
  - "A-020"
title: "Offer accepted followed by delayed start date or post-signing revocation"
...
probes:
  -
    id: "PROBE-A-020-1"
    action: "Request written confirmation of the revised start date alongside written clarification of whether hardware shipment and payroll registration remain active."
    expected_signal: "Separates an administrative IT delay from a structural hiring freeze or pre-start headcount cancellation."
    cost: "low"
    outcomes:
      -
...
specimens:
  -
    kind: "email"
    label: "Post-acceptance start date slippage"
    subject: "Update on your upcoming start date"
    lines:
      -
        at: "day -7"
        text: "We are excited to welcome you next Monday!"
        tell: false
      -
        at: "day -2"
        text: "Due to internal team restructuring, we need to push your start date by three weeks."
        tell: true
      -
        at: "day +15"
        text: "We are still finalizing leadership approvals for the revised onboarding date."
        tell: true
...
non_inferences:
  - "Does not establish that the candidate's performance or background check caused the delay."
  - "Does not establish that the role was fraudulent when the offer was originally issued."
status: "active"
---

# Offer accepted followed by delayed start date or post-signing revocation

A signed offer is met with repeated start-date delays, pre-day-one communication freezes, or sudden revocation during early onboarding.
