---
id: "obs.feedback_naming_as_absent_something_the_submitted_work_contains"
type: "artifact"
aliases:
  - "A-019"
title: "Feedback naming as absent something the submitted work contains"
summary: "The stated shortfall is the absence of work that is present in what the candidate submitted, at the path they gave."
stages:
  - "screening"
  - "technical"
perspectives:
...
probes:
  -
    id: "PROBE-A-019-1"
    action: "Open the submitted path in a private window with no session, and note what the first screen shows before any navigation."
    expected_signal: "Establishes what a reader with no context and no time actually lands on."
    cost: "low"
    outcomes:
      -
...
specimens:
  -
    kind: "email"
    label: "Feedback after screening"
    subject: "Following your application"
    lines:
      -
        text: "The team was looking for evidence of distributed systems work, and we did not see any in your materials."
        tell: true
      -
        text: "We would encourage you to apply again once you have that experience."
      -
        text: "The submitted index named three services and the path to each."
        tell: true
    reading: "Two sentences that cannot both hold. Either the work is absent or it was not opened — and only the second is consistent with a submission that names it."
non_inferences:
  - "Does not establish that the work was never opened, only that the claim and the submission disagree."
  - "Does not establish that the work would have met the bar had it been read."
---

# Feedback naming as absent something the submitted work contains

The stated shortfall is the absence of work that is present in what the candidate submitted, at the path they gave.
