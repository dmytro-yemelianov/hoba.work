...
states:
  ...
  -
    ...
    entities:
      ...
      - "B-014"
      - "M-006"
    visible_to_candidate: "The posting, and whatever the posting chose to disclose."
  -
    id: "received"
  ...
  -
    ...
    kind: "active"
    owner: "recruiter"
    description: "Waiting to be read by a person, against an inbound queue that is usually larger than the week has hours for."
    entities:
      - "B-003"
      - "M-009"
      - "M-016"
    visible_to_candidate: "Silence, of an indeterminate length."
  -
    id: "recruiter-screen"
    ...
    entities:
      ...
      - "M-004"
      - "M-017"
    visible_to_candidate: "The call itself, and whichever parameters the recruiter chose to share."
  -
    id: "technical"
...
transitions:
  ...
  -
    ...
    owner: "hiring-manager"
    guard: "The score falls short, or the review was too shallow to find what was there."
    entities:
      - "A-008"
      - "M-001"
      - "M-019"
