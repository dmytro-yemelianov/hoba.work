...
// Clear existing content directories first
fs.rmSync(path.join(rootDir, 'content'), { recursive: true, force: true });
fs.rmSync(path.join(rootDir, 'content-uk'), { recursive: true, force: true });
...
const mechanisms = [
  {
    ...
    operates_at: ['B-005', 'B-006', 'B-007'],
    emissions: [
      { artifact: 'A-008', fidelity: 'direct', likelihood: 'high', evidence: ['EVD-006'] },
      { artifact: 'A-002', fidelity: 'euphemism', likelihood: 'medium', evidence: ['EVD-001'] }
    ],
    facets: {
      actor: 'candidate',
      nature: 'rule',
  ...
  },
  {
    ...
    operates_at: ['B-007', 'B-008', 'B-010'],
    emissions: [
      { artifact: 'A-002', fidelity: 'euphemism', likelihood: 'high', evidence: ['EVD-001'] },
      { artifact: 'A-003', fidelity: 'distortion', likelihood: 'low', evidence: ['EVD-004'] }
    ],
    facets: {
      actor: 'candidate',
      nature: 'rule',
  ...
  },
  {
    ...
    operates_at: ['B-001', 'B-002'],
    emissions: [
      { artifact: 'A-001', fidelity: 'void', likelihood: 'medium', evidence: ['EVD-001'] },
      { artifact: 'A-009', fidelity: 'direct', likelihood: 'high', evidence: ['EVD-001'] }
    ],
    facets: {
      actor: 'system',
      nature: 'noise',
  ...
  },
  {
    ...
    operates_at: ['B-004', 'B-009'],
    emissions: [
      { artifact: 'A-002', fidelity: 'euphemism', likelihood: 'high', evidence: ['EVD-005'] },
      { artifact: 'A-005', fidelity: 'direct', likelihood: 'medium', evidence: ['EVD-005'] },
      { artifact: 'A-013', fidelity: 'euphemism', likelihood: 'medium', evidence: ['EVD-002'] }
    ],
    facets: {
      actor: 'policy',
      nature: 'rule',
  ...
  },
  {
    ...
    operates_at: ['B-001', 'B-003', 'B-007'],
    emissions: [
      { artifact: 'A-002', fidelity: 'euphemism', likelihood: 'high', evidence: ['EVD-004'] },
      { artifact: 'A-003', fidelity: 'euphemism', likelihood: 'medium', evidence: ['EVD-004'] }
    ],
    facets: {
      actor: 'policy',
      nature: 'incentive',
  ...
  },
  {
    ...
    operates_at: ['B-001', 'B-002', 'B-003'],
    emissions: [
      { artifact: 'A-001', fidelity: 'void', likelihood: 'high', evidence: ['EVD-004'] },
      { artifact: 'A-004', fidelity: 'noise', likelihood: 'medium', evidence: ['EVD-004'] }
    ],
    facets: {
      actor: 'system',
      nature: 'void',
  ...
  },
  {
    ...
    operates_at: ['B-008', 'B-010', 'B-012'],
    emissions: [
      { artifact: 'A-003', fidelity: 'direct', likelihood: 'high', evidence: ['EVD-004'] },
      { artifact: 'A-011', fidelity: 'direct', likelihood: 'high', evidence: ['EVD-004'] }
    ],
    facets: {
      actor: 'policy',
      nature: 'rule',
  ...
  },
  {
    ...
    operates_at: ['B-003', 'B-004'],
    emissions: [
      { artifact: 'A-001', fidelity: 'void', likelihood: 'high', evidence: ['EVD-001'] },
      { artifact: 'A-012', fidelity: 'noise', likelihood: 'medium', evidence: ['EVD-001'] }
    ],
    facets: {
      actor: 'recruiter',
      nature: 'incentive',
  ...
  },
  {
    ...
    operates_at: ['B-005', 'B-007', 'B-008'],
    emissions: [
      { artifact: 'A-008', fidelity: 'distortion', likelihood: 'medium', evidence: ['EVD-006'] },
      { artifact: 'A-014', fidelity: 'direct', likelihood: 'high', evidence: ['EVD-006'] }
    ],
    facets: {
  ...
  },
  {
    ...
    operates_at: ['B-002', 'B-003'],
    emissions: [
      { artifact: 'A-001', fidelity: 'void', likelihood: 'high', evidence: ['EVD-003'] },
      { artifact: 'A-002', fidelity: 'euphemism', likelihood: 'high', evidence: ['EVD-003'] }
    ],
    facets: {
      actor: 'system',
      nature: 'bias',
  ...
  },
  {
    ...
    operates_at: ['B-005', 'B-007', 'B-008'],
    emissions: [
      { artifact: 'A-007', fidelity: 'direct', likelihood: 'high', evidence: ['EVD-001'] },
      { artifact: 'A-001', fidelity: 'noise', likelihood: 'medium', evidence: ['EVD-001'] }
    ],
    facets: {
      actor: 'hiring-manager',
      nature: 'noise',
  ...
  },
  {
    ...
    operates_at: ['B-007', 'B-008', 'B-009'],
    emissions: [
      { artifact: 'A-003', fidelity: 'distortion', likelihood: 'medium', evidence: ['EVD-004'] },
      { artifact: 'A-004', fidelity: 'direct', likelihood: 'high', evidence: ['EVD-004'] }
    ],
    facets: {
      actor: 'hiring-manager',
      nature: 'noise',
  ...
  },
  {
    ...
    operates_at: ['B-004', 'B-008'],
    emissions: [
      { artifact: 'A-010', fidelity: 'direct', likelihood: 'high', evidence: ['EVD-006'] },
      { artifact: 'A-002', fidelity: 'euphemism', likelihood: 'high', evidence: ['EVD-001'] }
    ],
    facets: {
      actor: 'candidate',
  ...
  },
  {
    ...
    operates_at: ['B-003', 'B-004'],
    emissions: [
      { artifact: 'A-012', fidelity: 'distortion', likelihood: 'high', evidence: ['EVD-001'] },
      { artifact: 'A-001', fidelity: 'void', likelihood: 'medium', evidence: ['EVD-001'] }
    ],
    facets: {
      actor: 'recruiter',
  ...
  },
  {
    ...
    operates_at: ['B-003', 'B-004', 'B-007'],
    emissions: [
      { artifact: 'A-013', fidelity: 'direct', likelihood: 'high', evidence: ['EVD-002'] },
      { artifact: 'A-002', fidelity: 'euphemism', likelihood: 'high', evidence: ['EVD-001'] }
    ],
    facets: {
      actor: 'recruiter',
  ...
  },
  {
    ...
    operates_at: ['B-004', 'B-007'],
    emissions: [
      { artifact: 'A-002', fidelity: 'euphemism', likelihood: 'high', evidence: ['EVD-001'] },
      { artifact: 'A-008', fidelity: 'direct', likelihood: 'medium', evidence: ['EVD-006'] }
    ],
    facets: {
      actor: 'hiring-manager',
      nature: 'bias',
  ...
  },
  {
    ...
    operates_at: ['B-006'],
    emissions: [
      { artifact: 'A-006', fidelity: 'noise', likelihood: 'medium', evidence: ['EVD-006'] },
      { artifact: 'A-002', fidelity: 'euphemism', likelihood: 'high', evidence: ['EVD-001'] }
    ],
    facets: {
      actor: 'hiring-manager',
  ...
  },
  {
    ...
    operates_at: ['B-001', 'B-003'],
    emissions: [
      { artifact: 'A-002', fidelity: 'void', likelihood: 'high', evidence: ['EVD-001'] },
      { artifact: 'A-001', fidelity: 'void', likelihood: 'medium', evidence: ['EVD-001'] }
    ],
    facets: {
      actor: 'system',
  ...
  },
  {
    ...
    operates_at: ['B-011'],
    emissions: [
      { artifact: 'A-011', fidelity: 'direct', likelihood: 'high', evidence: ['EVD-001'] },
      { artifact: 'A-002', fidelity: 'euphemism', likelihood: 'medium', evidence: ['EVD-001'] }
    ],
    facets: {
      actor: 'candidate',
...
const patterns = [
  {
    ...
    required_artifacts: ['A-002', 'A-013'],
    compatible_mechanisms: ['M-001', 'M-004', 'M-017'],
  ...
  },
  {
    ...
    required_artifacts: ['A-003', 'A-004'],
    compatible_mechanisms: ['M-002', 'M-006', 'M-010', 'M-013'],
  ...
  },
  {
    ...
    required_artifacts: ['A-002', 'A-009'],
    compatible_mechanisms: ['M-008', 'M-024'],
  ...
  },
  {
    ...
    required_artifacts: ['A-002', 'A-005'],
    compatible_mechanisms: ['M-004', 'M-017'],
...
const loops = [
  {
    ...
    mechanisms: ['M-011', 'M-008', 'M-009'],
    edges: [
      { from: 'M-011', to: 'M-008', relation: 'amplifies' },
      { from: 'M-008', to: 'M-009', relation: 'amplifies' },
      { from: 'M-009', to: 'M-011', relation: 'amplifies' }
    ],
    entry_points: ['M-011'],
    interventions: ['I-004'],
    evidence_ids: ['EVD-003']
  },
  {
    ...
    mechanisms: ['M-012', 'M-019'],
    edges: [
      { from: 'M-012', to: 'M-019', relation: 'amplifies' },
      { from: 'M-019', to: 'M-012', relation: 'amplifies' }
    ],
    entry_points: ['M-012'],
    interventions: ['I-006'],
    evidence_ids: ['EVD-006']
  },
  {
    ...
    mechanisms: ['M-024', 'M-008', 'M-013'],
    edges: [
      { from: 'M-024', to: 'M-008', relation: 'amplifies' },
      { from: 'M-008', to: 'M-013', relation: 'amplifies' },
      { from: 'M-013', to: 'M-024', relation: 'amplifies' }
    ],
    entry_points: ['M-024'],
    interventions: ['I-001', 'I-003'],
...
const interventions = [
  ...
  },
  {
    ...
    targets: ['M-001', 'M-010', 'B-007', 'B-008'],
...
writeContent('en');
writeContent('uk');
console.log('Regenerated content without HOBA- prefix.');
