...
states:
  -
    ...
    description: "Менеджер описує роль. Рівень, вилку й вимоги вирішують саме тут — зазвичай копіюючи попередній пошук для тієї самої команди."
    entities:
      - "B-013"
  ...
  -
    ...
    description: "Фінанси й керівництво резервують бюджет під вакансію. Погодження може спливти або бути відкликаним пізніше, і воронка цього не помітить."
    entities:
      - "B-013"
      - "B-010"
  ...
  -
    ...
    kind: "active"
    owner: "recruiter"
    description: "Роль публічна. Її ще й можуть автоматично оновлювати кожні тридцять днів, і це виглядає точно як нова позиція."
    entities:
      - "B-013"
      - "B-014"
      - "M-006"
    visible_to_candidate: "Оголошення й те, що воно вирішило розкрити."
  -
    id: "received"
  ...
  -
    ...
    kind: "active"
    owner: "ats-vendor"
    description: "Екстракція парсера, пороги ключових слів, нокаут-правила й ранжування. Вирішується менш ніж за секунду."
    entities:
      - "B-002"
      - "M-003"
      - "M-008"
  ...
  -
    ...
    kind: "active"
    owner: "recruiter"
    description: "Очікує, поки прочитає людина, у вхідній черзі, яка зазвичай більша, ніж годин у тижні."
    entities:
      - "B-003"
      - "M-009"
      - "M-016"
    visible_to_candidate: "Тиша невизначеної довжини."
  -
    id: "recruiter-screen"
    ...
    entities:
      ...
      - "M-004"
      - "M-017"
    visible_to_candidate: "Сам дзвінок і ті параметри, які рекрутер вирішив розкрити."
  -
    id: "technical"
    title: "Технічна перевірка"
    kind: "active"
    owner: "hiring-manager"
    description: "Жива задача, тестове або і те, і те — оцінюють за шкалою, якої кандидат не бачить."
    entities:
      - "B-005"
      - "B-006"
      - "A-006"
  ...
  -
    ...
    kind: "terminal"
    owner: "ats-vendor"
    description: "Ніхто нічого не вирішував. Запис переріс поріг, або оголошення так і не зняли."
    entities:
      - "A-001"
      - "A-012"
      - "M-006"
...
transitions:
  ...
  -
    ...
    owner: "ats-vendor"
    guard: "Оцінка екстракції й усі нокаут-правила проходять."
    entities:
      - "B-002"
  -
    from: "machine-screened"
  ...
  -
    ...
    owner: "ats-vendor"
    guard: "Перегляду не сталося до порогу закриття."
    entities:
      - "M-020"
  -
  ...
  -
    ...
    owner: "hiring-manager"
    guard: "Оцінка не дотягує — або перевірка була занадто поверховою, щоб побачити те, що там було."
    entities:
      - "A-008"
      - "M-001"
      - "M-019"
  -
    ...
    owner: "hiring-manager"
    guard: "Консенсус досягає порогу «брати»."
    entities:
      - "B-007"
      - "B-008"
  -
    ...
    owner: "hiring-manager"
    guard: "Розколота панель під правилом одностайності за замовчуванням дає «не брати»."
    entities:
      - "A-014"
      - "M-022"
  -
  ...
  -
    ...
    owner: "employer-policy"
    guard: "Фриз дотягується до невиконаного офферу раніше за зустрічний підпис."
    entities:
      - "A-011"
      - "M-007"
  -
  ...
  -
    ...
    owner: "employer-policy"
    guard: "Невідповідність запису або регуляторна перешкода не знята."
    entities:
      - "M-021"
  -
    from: "published"
