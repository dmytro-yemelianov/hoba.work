...
const en = {
  ...
  'tour.home.step5.text': 'Switch the viewpoint lens in the navigation bar to inspect the system from the seat of a Candidate, Recruiter, Hiring Manager, ATS Vendor, or Policy Maker.',
...
const uk: Record<UIKey, string> = {
  ...
  'tour.home.step5.text': 'Перемикайте кут зору у верхній панелі, щоб дослідити систему з позиції Кандидата, Рекрутера, Найм-менеджера, ATS-вендора чи Роботодавця.',
