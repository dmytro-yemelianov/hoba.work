...
const uk: Record<UIKey, string> = {
  ...
  'actors.intro': 'Кожен механізм у реєстрі — це чиєсь рішення, ухвалене з позиції з власним полем зору. Ось усі сім: що кожна вирішує, чого їй структурно не видно, за чим її оцінюють і що вона могла б робити інакше.',
