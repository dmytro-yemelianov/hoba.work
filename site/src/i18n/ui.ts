...
const en = {
  ...
  'check.preset.impossible': 'P-003: Impossible Tech Years',
  'check.preset.salary': 'P-004: Above Salary Band',
  ...
  'check.runway.desc': 'Assess your search horizon and exposure to down-levelling pressure (M-017) and uncalibrated bets (P-004) under current baseline burn.',
  ...
  'gap.mechanismsText': 'A mechanism no intervention targets. {n} of {total}. The split below matters: where the atlas records that no named actor holds a lever, the absence is a finding; everywhere else it is an omission.',
  ...
  'home.role.researcher.desc': 'Explore 113+ verified nodes, Lean 4 mathematical proofs, and systemic causal feedback loops.',
  ...
  'analyze.scenarios.ghost-refresh': 'Ghost Requisition & Pipeline Refresh',
  'analyze.scenarios.ats-knockout': 'Automated Parsing Knockout',
  'analyze.scenarios.post-panel-freeze': 'Post-Panel Freeze & Silence',
  'analyze.scenarios.downlevelling-trap': 'Down-Levelling & Delayed Start',
  ...
  'tour.home.step1.text': 'hoba is an open, machine-readable atlas of 89 causal nodes explaining why the hiring funnel stalls and what structural dynamics operate behind it.',
  'tour.home.step2.title': 'Four Interactive Exploration Engines',
  'tour.home.step2.text': 'Use Situation Analysis (diagnostic wizard), Conformance Check (posting audit), Process Simulator (state machines), or Knowledge Graph to explore causal chains.',
  'tour.home.step3.title': 'Role-Specific Pathways',
  'tour.home.step3.text': 'Whether you are a job seeker analyzing silence, a hiring team debugging funnel drop-off, or an engineer reviewing systemic loops, tailored entry points guide your journey.',
  'tour.home.step4.title': '100% Client-Side Privacy',
  'tour.home.step4.text': 'All calculations and audits run completely inside your local browser. Zero telemetry, zero tracking, and no server database collection.',

  'tour.analyze.title': 'Situation Analysis Guide',
  'tour.analyze.step1.title': 'Step 1: Witnessed Facts (H)',
  'tour.analyze.step1.text': 'Select real observations you experienced (late-night automated rejections, take-home tasks, ghosting delays) or pick a preset scenario.',
  'tour.analyze.step2.title': 'Step 2: Funnel Obstacle (O)',
  'tour.analyze.step2.text': 'The engine identifies which exact funnel gate and knockout filter stopped your application on the canonical pipeline.',
  'tour.analyze.step3.title': 'Step 3: Root Mechanisms (B)',
  'tour.analyze.step3.text': 'Logically derive compatible root mechanisms (such as ghost requisitions or market asymmetry) rather than engaging in speculative self-blame.',
  'tour.analyze.step4.title': 'Step 4: Agency Zones & Probes (A)',
  'tour.analyze.step4.text': 'Separate what is within candidate control from what is strictly exogenous, and review falsifiable diagnostic probes to settle ambiguities.',

  'tour.check.title': 'Conformance Check Guide',
  'tour.check.step1.title': 'Step 1: Your Evidenced Facts',
  'tour.check.step1.text': 'Enter your verifiable dated experience, location rights, and compensation requirements on the left column.',
  'tour.check.step2.title': 'Step 2: Stated Mandatory Specs',
  'tour.check.step2.text': 'Input the job posting hard criteria: minimum years, required phrases, location constraints, and salary bands.',
  'tour.check.step3.title': 'Step 3: Arithmetic Verdict',
  'tour.check.step3.text': 'The engine deterministically checks if any mathematical knockout gate fires (e.g. impossible technology experience years P-003 or salary cap P-004).',
  'tour.check.step4.title': 'Step 4: Latency & Financial Runway',
  'tour.check.step4.text': 'Diagnose stage turnaround anomalies and calculate your financial solvency horizon to prevent search exhaustion.',

  'tour.process.title': 'Process Simulator Guide',
  'tour.process.step1.title': 'Step 1: Choose a Pipeline',
  'tour.process.step1.text': 'Select between the Canonical Hiring Path (WF-003), ATS Pipeline (WF-002), End-to-End Funnel (WF-001), or Client Contracting (WF-004).',
  'tour.process.step2.title': 'Step 2: Playback & Auto Pan-Zoom',
  'tour.process.step2.text': 'Use Step or Auto-Play with adjustable playback speed. The canvas automatically pans and zooms to keep the active state centered.',
  'tour.process.step3.title': 'Step 3: Walk It Yourself (Choose Mode)',
  'tour.process.step3.text': 'Switch to "Walk it yourself" to choose your own branch at each decision point and generate a shareable replay link.',
  'tour.process.step4.title': 'Step 4: Step Detail & Broken Commitments',
  'tour.process.step4.text': 'Examine candidate visibility, responsible decision actors, and documented failure modes for every individual state.',

  'tour.graph.title': 'Knowledge Graph Guide',
  'tour.graph.step1.title': 'Step 1: Topological DAG View',
  'tour.graph.step1.text': 'Explore the complete 89-node graph arranged along the hiring funnel x-axis, with Tarjan feedback loops and causal chains.',
  'tour.graph.step2.title': 'Step 2: Filter Layers & Agency',
  'tour.graph.step2.text': 'Toggle entity layers (Artifacts, Barriers, Mechanisms, Patterns, Loops, Interventions) and filter by Candidate/Intermediary/Exogenous control.',
  'tour.graph.step3.title': 'Step 3: Node Inspector',
  'tour.graph.step3.text': 'Click any node to open the side inspector with its evidence grade, facts, and link to the dedicated entity page.',
  'tour.graph.step4.title': 'Step 4: Canvas Navigation',
  'tour.graph.step4.text': 'Drag to pan, scroll to zoom, click Fit to reset framing, or enter Fullscreen mode for deep exploration.',
  ...
  'tour.registry.step2.title': 'Step 2: Grouping Options',
  'tour.registry.step2.text': 'Group records by Entity Type, Funnel Stage, or Agency Zone for clean categorical browsing.',
  'tour.registry.step3.title': 'Step 3: View Switcher',
  ...
  'tour.registry.step4.title': 'Step 4: Machine-Readable Data',
  ...
  'tour.eras.step2.title': 'Step 2: Capital Dynamics',
  ...
  'tour.actors.step2.title': 'Step 2: Epistemic Asymmetry',
  ...
  'tour.actors.step3.title': 'Step 3: Global Lens Filter',
  'tour.actors.step3.text': 'Use the Lens selector in the top navbar to filter the entire atlas from one single actor’s viewpoint.',
...
const uk: Record<UIKey, string> = {
  ...
  'check.preset.impossible': 'P-003: Неможливий стаж технології',
  'check.preset.salary': 'P-004: Очікування вище вилки',
  ...
  'check.runway.desc': 'Оцініть горизонт пошуку та вразливість до тиску зниження грейду (M-017) чи невдалих ставок (P-004) за поточних витрат.',
  ...
  'gap.mechanismsText': 'Механізм, на який не спрямована жодна інтервенція. {n} із {total}. Поділ нижче важливий: там, де атлас записав, що важеля не тримає ніхто з названих сторін, відсутність змін — це висновок; в усіх інших випадках це недогляд.',
  ...
  'home.role.researcher.desc': 'Досліджуйте 113+ верифікованих вузлів, математичні доведення в Lean 4 та системні причинні цикли.',
  ...
  'analyze.scenarios.ghost-refresh': 'Фантомна вакансія та оновлення пулу',
  'analyze.scenarios.ats-knockout': 'Автоматичний відсів ATS за ключовими словами',
  'analyze.scenarios.post-panel-freeze': 'Замороження бюджету після фінальної панелі',
  'analyze.scenarios.downlevelling-trap': 'Зниження грейду та затримка дати виходу',
  ...
  'tour.home.step1.text': 'hoba — це відкритий машиночитний атлас із 89 причинних вузлів, що пояснює, чому воронка найму буксує і яка прихована динаміка стоїть за цим.',
  'tour.home.step2.title': 'Чотири інтерактивні інструменти',
  'tour.home.step2.text': 'Використовуйте Аналіз ситуації (діагностика), Перевірку відповідності (аудит умов), Симулятор процесу (стейт-машини) або Граф для дослідження каузальних звʼязків.',
  'tour.home.step3.title': 'Маршрути для різних ролей',
  'tour.home.step3.text': 'Для шукачів роботи, команд найму чи інженерів передбачено адаптовані точки входу та спеціалізовані підкасти даних.',
  'tour.home.step4.title': '100% клієнтська конфіденційність',
  'tour.home.step4.text': 'Усі розрахунки та аналізи виконуються суто у вашому браузері. Жодних трекерів, збору персональних даних чи збереження на сервері.',

  'tour.analyze.title': 'Гід з аналізу ситуації',
  'tour.analyze.step1.title': 'Крок 1: Спостережувані факти (H)',
  'tour.analyze.step1.text': 'Оберіть реальні спостереження, з якими ви зіткнулися (нічні шаблонні відмови, тестові завдання, затримки), або завантажте готовий емпіричний сценарій.',
  'tour.analyze.step2.title': 'Крок 2: Барʼєр воронки (O)',
  'tour.analyze.step2.text': 'Діагностичний рушій точно визначає, на якому саме фільтрі чи нокаут-гейті канонічного шляху зупинився процес.',
  'tour.analyze.step3.title': 'Крок 3: Кореневі механізми (B)',
  'tour.analyze.step3.text': 'Отримайте перелік логічно сумісних прихованих причин (фантомні вакансії, ринкова асиметрія) без самозвинувачень.',
  'tour.analyze.step4.title': 'Крок 4: Зони контролю та проби (A)',
  'tour.analyze.step4.text': 'Розмежуйте те, що під контролем кандидата, від екзогенних факторів, та перегляньте фальсифіковані діагностичні проби.',
  ...
  'tour.check.step3.text': 'Система детерміновано обчислює, чи спрацьовує математичний нокаут-фільтр (наприклад, неможливий досвід P-003 або перевищення вилки P-004).',
  'tour.check.step4.title': 'Крок 4: Затримки та фінансовий ранвей',
  'tour.check.step4.text': 'Оцініть аномалії термінів проходження етапів і розрахуйте горизонт фінансової стійкості під час пошуку.',

  'tour.process.title': 'Гід із симулятора процесу',
  'tour.process.step1.title': 'Крок 1: Оберіть процес найму',
  'tour.process.step1.text': 'Перемикайтеся між Канонічним шляхом (WF-003), Пайплайном ATS (WF-002), Наскрізною воронкою (WF-001) або Клієнтським наймом (WF-004).',
  'tour.process.step2.title': 'Крок 2: Автоплей та авто-зум',
  'tour.process.step2.text': 'Запускайте автопрогравання зі зручною швидкістю. Камера автоматично фокусується і масштабується на активному стані.',
  'tour.process.step3.title': 'Крок 3: Власний вибір (Choose Mode)',
  'tour.process.step3.text': 'Перемкніться на «Пройти власноруч», обирайте розгалуження на кожному кроці та отримуйте збережуване посилання на свій шлях.',
  'tour.process.step4.title': 'Крок 4: Деталізація кроку',
  'tour.process.step4.text': 'Переглядайте, що саме бачить кандидат, хто ухвалює рішення та які задокументовані збої виникають на цьому етапі.',

  'tour.graph.title': 'Гід з провідника графа',
  'tour.graph.step1.title': 'Крок 1: Топологічний вигляд DAG',
  'tour.graph.step1.text': 'Досліджуйте повну мережу з 89 вузлів, розташованих за етапами воронки з виділенням причинних петель Тарʼяна.',
  'tour.graph.step2.title': 'Крок 2: Шари та зони впливу',
  'tour.graph.step2.text': 'Фільтруйте типи сутностей (Спостереження, Барʼєри, Механізми, Патерни, Петлі, Інтервенції) та зони контролю.',
  'tour.graph.step3.title': 'Крок 3: Інспектор вузла',
  'tour.graph.step3.text': 'Клікніть на будь-який вузол на полотні, щоб відкрити бічну панель із рівнем доказовості, фактами та посиланням на детальну сторінку.',
  'tour.graph.step4.title': 'Крок 4: Навігація полотном',
  'tour.graph.step4.text': 'Перетягуйте для переміщення, масштабуйте колесом миші, центруйте кнопкою Fit або відкривайте у повноекранному режимі.',
  ...
  'tour.registry.step2.title': 'Крок 2: Групування записів',
  'tour.registry.step2.text': 'Групуйте записи за типами сутностей, етапами воронки або зонами контролю для структурованого перегляду.',
  'tour.registry.step3.title': 'Крок 3: Перемикання виглядів',
  'tour.registry.step3.text': 'Обирайте між структурованою Таблицею, інформативними Картками або компактним Списком під ваш пристрій.',
  'tour.registry.step4.title': 'Крок 4: Машиночитні дані',
  ...
  'tour.eras.step2.title': 'Крок 2: Динаміка капіталу',
  ...
  'tour.eras.step3.title': 'Крок 3: Верифіковані індикатори',
  ...
  'tour.actors.step2.title': 'Крок 2: Епістемічна асиметрія',
  ...
  'tour.actors.step3.title': 'Крок 3: Глобальна лінза',
  'tour.actors.step3.text': 'Використовуйте перемикач «Точка зору» у верхній навігації, щоб фільтрувати весь атлас під кутом зору обраного актора.',
