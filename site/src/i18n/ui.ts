...
const en = {
  ...
  'home.role.researcher.desc': 'Explore 89 verified nodes, Lean 4 mathematical proofs, and systemic causal feedback loops.',
  ...
  'tour.check.step3.text': 'The engine deterministically checks whether any mathematical knockout gate fires (such as impossible technology experience P-003 or salary cap P-004).',
  ...
  'tour.process.step1.text': 'Switch between the Canonical Hiring Path (WF-003), ATS Pipeline (WF-002), End-to-End Funnel (WF-001), or Client Contracting (WF-004).',
  ...
  'tour.graph.step3.title': 'Step 3: Canonical Ideal Route (WF-003)',
  'tour.graph.step3.text': 'Click "✨ Canonical path (WF-003)" to activate the step-by-step HUD walkthrough with glowing transition edges and sequential badges.',
...
const uk: Record<UIKey, string> = {
  ...
  'home.role.researcher.desc': 'Досліджуйте 89 верифікованих вузлів, математичні доведення в Lean 4 та системні причинні цикли.',
  ...
  'tour.graph.step3.title': 'Крок 3: Канонічний ідеальний маршрут (WF-003)',
  'tour.graph.step3.text': 'Клікніть «✨ Ідеальний маршрут (WF-003)», щоб увімкнути покроковий HUD із підсвіченими послідовними стрілками переходу.',
