  ...
  -
    ...
    outcomes:
      -
        ...
        excludes: []
        because: "An upfront location constraint weighs against the claim that this criterion was introduced only after the application arrived."
      -
        ...
        excludes: []
        because: "An unstated location criterion makes post-hoc constraint injection more plausible than evaluation solely against the published terms."
      -
        id: "posting-edited"
        ...
        weighs_against:
          - "mech.genuine_technical_skill_shortfall"
        excludes: []
        because: "A dated post-application edit makes a mid-process criterion change more plausible than an unchanged initial requirement."
      -
        id: "no-saved-copy"
