  ...
  -
    ...
    outcomes:
      -
        ...
        excludes: []
        because: "A written pause date is more consistent with a headcount freeze than with a skill decision or an undated evergreen listing."
      -
        ...
        weighs_against:
          - "mech.genuine_technical_skill_shortfall"
        excludes: []
        because: "Written headcount cancellation makes a candidate-skill explanation less plausible for the withdrawn offer."
      -
        ...
        weighs_against:
          - "mech.genuine_technical_skill_shortfall"
        excludes: []
        because: "A company-wide scope makes a systemic budget or policy constraint more plausible than an individual candidate cause."
      -
