  ...
  -
    ...
    outcomes:
      -
        ...
        excludes: []
        because: "An active referral to an open higher-level role weighs against a hard organizational ceiling, though it does not guarantee that role is attainable."
      -
      ...
      -
        ...
        excludes: []
        because: "A stated departmental budget ceiling makes a pay-band constraint more plausible than a skill deficit as the immediate reason."
      -
        id: "no-reply"
