  ...
  -
    ...
    outcomes:
      -
        ...
        excludes: []
        because: "Withdrawal without reposting weighs against an evergreen listing, though it does not by itself verify who filled the role."
      -
        ...
        excludes: []
        because: "Immediate identical reposting makes a completed internal fill less plausible as the whole explanation."
      -
        id: "still-live"
        ...
        weighs_against:
          - "mech.genuine_technical_skill_shortfall"
        excludes: []
        because: "Continued application intake makes a fully completed closure less plausible, though multiple openings or delayed administration remain possible."
      -
        id: "cannot-establish"
