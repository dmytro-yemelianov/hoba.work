---
id: "evidence.probation_period_limits_and_dismissal_standards_ukraine_labour_code_art_26_28"
type: "evidence"
aliases:
  - "EVD-040"
...
summary: >-
  ...
  exceed three months for standard employees (or six months in exceptional
...
- **Kind:** `primary`
- **Citation:** Кодекс законів про працю України, статті 26, 27, 28 (Випробування при прийнятті на роботу, строк випробування, наслідки результату випробування).
- **Source:** [zakon.rada.gov.ua](https://zakon.rada.gov.ua/laws/show/322-08)
